      ...
      <div className="max-w-7xl mx-auto px-6 pt-24 pb-32 grid md:grid-cols-12 gap-10 relative">
        <div className="md:col-span-7">
          ...
          <div className="flex gap-4 mt-10 flex-wrap">
            <Link to="/booking" className="glow px-7 py-4 rounded-full font-semibold bg-accent text-bg hover:bg-accent-deep transition-colors">
              Записаться на сеанс →
            </Link>
            <Link to="/techniques" className="px-7 py-4 rounded-full border border-white/20 hover:border-accent transition-colors">
              О технике
            </Link>
          </div>
          <div className="flex gap-8 mt-12 text-sm text-white/50">
            <div><div className="serif text-4xl text-white">9 лет</div>в практике</div>
            <div><div className="serif text-4xl text-white">1 200+</div>клиентов</div>
            <div><div className="serif text-4xl text-white">4.98</div>средняя оценка</div>
          </div>
        </div>
        <div className="md:col-span-5 relative">
          ...
          <div className="relative rounded-3xl overflow-hidden card aspect-[4/5]">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black to-transparent pointer-events-none">
              ...
              <div className="serif text-3xl mt-1">{studio.address}</div>
