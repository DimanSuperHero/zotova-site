  ...
  return (
    <section id="reviews" className="max-w-7xl mx-auto px-6 py-20">
      <div className="text-center mb-14">
        ...
        <h2 className="serif text-6xl mt-4">Отзывы.</h2>
        <p className="text-white/50 mt-3">147 отзывов на 2ГИС · средняя оценка 4.98</p>
      </div>
      <div className="grid md:grid-cols-3 gap-6">
        {items.map((r, i) => (
          <div key={i} className="card rounded-3xl p-8 relative" style={i === 1 ? { background: 'linear-gradient(135deg,rgba(232,180,184,.08),transparent)' } : {}}>
