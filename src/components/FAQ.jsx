    ...
    <section id="faq" className="max-w-7xl mx-auto px-6 py-20">
      <div className="grid md:grid-cols-12 gap-12">
        <div className="md:col-span-4">
          ...
          <h2 className="serif text-6xl mt-4 leading-[1.0]">
        ...
        <div className="md:col-span-8 space-y-3">
          {faq.map((item, i) => (
            <details key={i} className="card rounded-2xl p-6 group" open={i === 0}>
              <summary className="flex justify-between items-center cursor-pointer list-none">
                <span className="serif text-2xl">{item.q}</span>
                <span className="text-2xl transition-transform group-open:rotate-45 text-accent">+</span>
              </summary>
